...
extension UIView {
    ...
    @discardableResult
    func autoAlignAxis(toSuperviewAxis axis: Axis, withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoPinEdgesToSuperviewEdges(with insets: UIEdgeInsets = .zero, excludingEdge edge: Edge) -> [NSLayoutConstraint] {
    ...
    @discardableResult
    func autoPinEdgeToSuperviewEdge(_ edge: Edge, withInset inset: CGFloat = 0) -> NSLayoutConstraint {
        return autoPinEdgeToSuperviewEdge(edge, withInset: inset, relation: .equal)
    }
    
    @discardableResult
    func autoPinEdgeToSuperviewEdge(_ edge: Edge, withInset inset: CGFloat, relation: NSLayoutRelation) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoPinEdge(_ edge: Edge, to toEdge: Edge, of otherView: UIView, withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
        return autoPinEdge(edge, to: toEdge, of: otherView, withOffset: offset, relation: .equal)
    }
    
    @discardableResult
    func autoPinEdge(_ edge: Edge, to toEdge: Edge, of otherView: UIView, withOffset offset: CGFloat, relation: NSLayoutRelation) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoAlignAxis(_ axis: Axis, toSameAxisOf otherView: UIView, withOffset offset: CGFloat = 0) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoSetDimension(_ dimension: Dimension, toSize size: CGFloat, relation: NSLayoutRelation = .equal) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoMatchDimension(_ dimension: Dimension, to toDimension: Dimension, of otherView: UIView, withOffset offset: CGFloat, relation: NSLayoutRelation = .equal) -> NSLayoutConstraint {
    ...
    @discardableResult
    func autoMatchDimension(_ dimension: Dimension, to toDimension: Dimension, of otherView: UIView, withMultiplier multiplier: CGFloat = 1.0) -> NSLayoutConstraint {
        return autoMatchDimension(dimension, to: toDimension, of: otherView, withMultiplier: multiplier, relation: .equal)
    }
    
    @discardableResult
    func autoMatchDimension(_ dimension: Dimension, to toDimension: Dimension, of otherView: UIView, withMultiplier multiplier: CGFloat, relation: NSLayoutRelation) -> NSLayoutConstraint {
